            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
              <div className="px-4 py-5 flex-auto">
                ...
                <select className="border border-gray-300 rounded-lg px-4 py-2 w-full">
                  <option value="">Choisir l'état</option>
                  {/* Ajoutez ici les options d'état en dur si nécessaire */}
                </select>
                <select className="border border-gray-300 rounded-lg px-4 py-2 mt-2 w-full">
                  <option value="">Choisir la ville</option>
                  {/* Ajoutez ici les options de ville en dur si nécessaire */}
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 w-full md:w-2/12 px-4 text-center">
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
              <div className="px-4 py-5 flex-auto">
                ...
                <select className="border border-gray-300 rounded-lg px-4 py-2 w-full">
                  <option value="">Choisir un domaine</option>
                  {/* Ajoutez ici les options de domaine en dur si nécessaire */}
                </select>
                <select className="border border-gray-300 rounded-lg px-4 py-2 mt-2 w-full">
                  <option value="">Choisir un sous-domaine</option>
                  {/* Ajoutez ici les options de sous-domaine en dur si nécessaire */}
                </select>
              </div>
            </div>
          </div>
