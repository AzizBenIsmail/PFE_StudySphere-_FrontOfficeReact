...
// this correct code before recorde
...
//                 style={{ maxWidth: "300px", maxHeight: "250px" }}
//               />
//             ) : isAudioFile(message.file.originalname) ? ( // Check if the file is an audio file
//               <audio controls>
//                 <source
//                   src={`http://localhost:5000/${message.file.originalname}`}
//                   type={`audio/${message.file.originalname.split(".").pop().toLowerCase()}`} // Set the correct audio type dynamically
