...
export default function EventModal() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (selectedEvent) {
        ...
        await updateEvent(selectedEvent._id, calendarEvent); // Changed .id to ._id
        console.log("Ahhhhhh");
        dispatchCalEvent({
          type: "update",
  ...
  //   try {
  //     if (selectedEvent) {
  //       await updateEvent(selectedEvent.id, calendarEvent);
  //       dispatchCalEvent({ type: "update", payload: calendarEvent });
  //     } else {
  //       const newEvent = await createEvent(calendarEvent); // Call createEvent function
  //       dispatchCalEvent({ type: "push", payload: newEvent });
  //     }
  //     setShowEventModal(false);
  //   } catch (error) {
  ...
  async function handleDelete() {
    try {
      console.log("selecteedddd :", selectedEvent);
