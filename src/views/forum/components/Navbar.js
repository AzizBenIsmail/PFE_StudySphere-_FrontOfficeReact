...
import UserDropdown from '../../../components/Dropdowns/UserDropdownLanding'
...
export default function Navbar ({ user }) {
  ...
  return (
    <>
      <nav
        className="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-bleu-500">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <Typography className="flex items-center" variant="h6" component="div">
            <Link
              to="/forum/create"
